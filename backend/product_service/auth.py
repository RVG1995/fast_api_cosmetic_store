"""Модуль аутентификации для сервиса продуктов с обработкой JWT токенов и авторизацией пользователей."""
...
class User:
    """Класс для представления пользователя с правами доступа."""
    
    def __init__(self, user_id: int, is_admin: bool = False, is_super_admin: bool = False, is_active: bool = True):
        """Инициализация пользователя с указанными правами доступа."""
        self.id = user_id
