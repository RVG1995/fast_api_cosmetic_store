...
async def send_email(recipient: str, subject: str, html_content: str) -> None:
    ...
    except (aiosmtplib.SMTPException, json.JSONDecodeError, asyncio.TimeoutError, ValueError) as e:
...
async def process_email_message(message: aio_pika.IncomingMessage) -> None:
    ...
    try:
        ...
        await message.ack()
    except (aio_pika.exceptions.AMQPException, aiosmtplib.SMTPException, json.JSONDecodeError, asyncio.TimeoutError, ValueError) as e:
